			...
			<div class="row">
				<div class="col-lg-6 col-md-12 caption-two-panel ml-auto pt-5">
					<div class="intro-caption mt-5">
						...
						<a class="btn btn-primary text-white mr-3" href="booking.php">Booking now</a>
					</div>
				</div>
			</div>
	</section>
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-6">
								<div class="service-block mb-5">
									...
									<p>It is the use of scissors to trim hair</p>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6">
								<div class="service-block mb-5">
							...
							<div class="col-lg-6 col-md-6 col-sm-6">
								<div class="service-block">
									...
									<p>It is the use of clippers for trimming hair, fading, or carving various patterns</p>
								</div>
							</div>
						</div>
					</div>
